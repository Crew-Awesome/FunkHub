...
contextBridge.exposeInMainWorld("funkhubDesktop", {
  installArchive: (payload) =>
    ipcRenderer.invoke("funkhub:installArchive", payload),
  installEngine: (payload) =>
    ipcRenderer.invoke("funkhub:installEngine", payload),
  cancelInstall: (payload) =>
    ipcRenderer.invoke("funkhub:cancelInstall", payload),
  launchEngine: (payload) =>
    ipcRenderer.invoke("funkhub:launchEngine", payload),
  ...
  openExternalUrl: (payload) =>
    ipcRenderer.invoke("funkhub:openExternalUrl", payload),
  ...
  startItchOAuth: (payload) =>
    ipcRenderer.invoke("funkhub:startItchOAuth", payload),
  listItchBaseGameReleases: () =>
    ipcRenderer.invoke("funkhub:listItchBaseGameReleases"),
  resolveItchBaseGameDownload: (payload) =>
    ipcRenderer.invoke("funkhub:resolveItchBaseGameDownload", payload),
  inspectEngineInstall: (payload) =>
    ipcRenderer.invoke("funkhub:inspectEngineInstall", payload),
  inspectPath: (payload) => ipcRenderer.invoke("funkhub:inspectPath", payload),
  importEngineFolder: (payload) =>
    ipcRenderer.invoke("funkhub:importEngineFolder", payload),
  importModFolder: (payload) =>
    ipcRenderer.invoke("funkhub:importModFolder", payload),
  ...
  updateSettings: (payload) =>
    ipcRenderer.invoke("funkhub:updateSettings", payload),
  ...
  scanCommonEnginePaths: () =>
    ipcRenderer.invoke("funkhub:scanCommonEnginePaths"),
